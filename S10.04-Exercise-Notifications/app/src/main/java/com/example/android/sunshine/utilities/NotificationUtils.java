...
public class NotificationUtils {
    ...
    private static final String FORECAST_NOTIFICATION_CHANNEL_ID = "forecast_notification_id";
...
//          COMPLETED (2) Use NotificationCompat.Builder to begin building the notification
            NotificationCompat.Builder notificationBuilder =
                    new NotificationCompat.Builder(context, FORECAST_NOTIFICATION_CHANNEL_ID)
