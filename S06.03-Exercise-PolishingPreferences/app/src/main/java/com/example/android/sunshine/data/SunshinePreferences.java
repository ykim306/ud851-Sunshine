...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String prefDefaultLocationDefault = context.getString(R.string.pref_location_default);
        return PreferenceManager.getDefaultSharedPreferences(context).getString(prefLocationKey, prefDefaultLocationDefault);
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        String prefMetricKey = context.getString(R.string.pref_units_key);
        String prefMetricDefault = context.getString(R.string.pref_units_metric);
        String preferredUnits = PreferenceManager.getDefaultSharedPreferences(context).getString(prefMetricKey, prefMetricDefault);
        return (preferredUnits.equals(prefMetricDefault));
    }
