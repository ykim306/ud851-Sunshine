...
public class MainActivity extends AppCompatActivity {
    ...
    private class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                String tempJsonResponse = NetworkUtils.getResponseFromHttpUrl(url);
                String[] weatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,tempJsonResponse);
                return weatherData;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
