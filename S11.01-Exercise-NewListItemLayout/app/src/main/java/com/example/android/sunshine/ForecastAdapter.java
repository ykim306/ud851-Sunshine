...
//          COMPLETED (6) Get references to all new views and delete this line
            weatherDate = view.findViewById(R.id.tv_Date);
            weatherDesc = view.findViewById(R.id.tv_Desc);
            weatherHigh = view.findViewById(R.id.tv_High);
            weatherLow = view.findViewById(R.id.tv_Low);
